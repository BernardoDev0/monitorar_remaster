	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'enter': 'fade-in 0.2s cubic-bezier(0.4, 0, 0.2, 1), scale-in 0.15s cubic-bezier(0.4, 0, 0.2, 1)',
				'exit': 'fade-out 0.2s cubic-bezier(0.4, 0, 0.2, 1), scale-out 0.15s cubic-bezier(0.4, 0, 0.2, 1)'
			}
		}
	},
